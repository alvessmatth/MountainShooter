...
class Menu:
    ...
    def run(self, ):
        ...
        while True:
            ...
            self.menu_text(text= "Mountain", text_size= 50, text_color=COLOR_ORANGE, text_center_pos=((WIN_WIDTH/2), 70))
            self.menu_text(text="Shooter", text_size=50, text_color=COLOR_ORANGE,text_center_pos=((WIN_WIDTH / 2), 120))
            ...
            # Check for all events on the queue
